...
async function getUsers(request, response, next) {
  try {
    const { page_number, page_size, sort = 'email:desc', search } = request.query;
...
//   try {
//     const { product, description, price, quantity } = request.body;

//     const success = await usersService.createTransaction(
//       product,
//       description,
//       price,
//       quantity
